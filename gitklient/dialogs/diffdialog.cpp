...
DiffDialog::DiffDialog(const Git::File &oldFile, const Git::File &newFile, QWidget *parent) : QDialog(parent),
      _oldFile(oldFile),
      _newFile(newFile)
{
    setupUi(this);
...
DiffDialog::DiffDialog(const QString &oldBranch, const QString &newBranch, QWidget *parent) : QDialog(parent)
