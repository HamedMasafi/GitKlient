...
public:
   ...
   */
    DiffPart(Operation _operation, const QString &_text);
    DiffPart();
    inline bool isNull() const;
    QString toString() const;
    bool operator==(const DiffPart &d) const;
    bool operator!=(const DiffPart &d) const;
...
public:
   ...
   */
    QList<DiffPart> diff_main(const QString &text1, const QString &text2);
   ...
   * @return Linked List of Diff objects.
   */
    QList<DiffPart> diff_main(const QString &text1, const QString &text2, bool checklines);
   ...
   */
private:
    QList<DiffPart> diff_main(const QString &text1, const QString &text2, bool checklines, clock_t deadline);
   ...
   */
private:
    QList<DiffPart> diff_compute(QString text1, QString text2, bool checklines, clock_t deadline);
   ...
   */
private:
    QList<DiffPart> diff_lineMode(QString text1, QString text2, clock_t deadline);
   ...
   */
protected:
    QList<DiffPart> diff_bisect(const QString &text1, const QString &text2, clock_t deadline);
   ...
   */
private:
    QList<DiffPart> diff_bisectSplit(const QString &text1, const QString &text2, int x, int y, clock_t deadline);
...
private:
   ...
   */
private:
    void diff_charsToLines(QList<DiffPart> &diffs, const QStringList &lineArray);
...
private:
   ...
   */
public:
    void diff_cleanupSemantic(QList<DiffPart> &diffs);
   ...
   */
public:
    void diff_cleanupSemanticLossless(QList<DiffPart> &diffs);
...
private:
   ...
   */
public:
    void diff_cleanupEfficiency(QList<DiffPart> &diffs);
   ...
   */
public:
    void diff_cleanupMerge(QList<DiffPart> &diffs);
   ...
   */
public:
    int diff_xIndex(const QList<DiffPart> &diffs, int loc);
   ...
   */
public:
    QString diff_prettyHtml(const QList<DiffPart> &diffs);
   ...
   */
public:
    QString diff_text1(const QList<DiffPart> &diffs);
   ...
   */
public:
    QString diff_text2(const QList<DiffPart> &diffs);
   ...
   */
public:
    int diff_levenshtein(const QList<DiffPart> &diffs);
   ...
   */
public:
    QString diff_toDelta(const QList<DiffPart> &diffs);
   ...
   */
public:
    QList<DiffPart> diff_fromDelta(const QString &text1, const QString &delta);
...
public:
   ...
   */
public:
    QList<Patch> patch_make(const QList<DiffPart> &diffs);
   ...
   */
public:
    QList<Patch> patch_make(const QString &text1, const QString &text2, const QList<DiffPart> &diffs);
   ...
   */
public:
    QList<Patch> patch_make(const QString &text1, const QList<DiffPart> &diffs);
